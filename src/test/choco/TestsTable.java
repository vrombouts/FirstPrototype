...
public class TestsTable {
    ...
    private static void checkTable(){
        ...
        jc.checkTableAC(new BiFunction<Set<Integer>[], Set<Integer[]>, Set<Integer>[]>() {
            @Override
            public Set<Integer>[] apply(Set<Integer>[] variables, Set<Integer[]> tablee) {
                ...
                try{solv.propagate();}catch(Exception e){
